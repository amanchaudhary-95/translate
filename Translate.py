...
dev = """:blue[**NLP Application - Machine Translation App**]  
...
c1, c2 = st.columns(2)
in_lang = c1.radio("Select Language", ["English", "Hindi", "Maori", 'Nepali'], horizontal=True, index=3, on_change=change_lang)
out_lang = c2.radio("Translation Language", ["English", "Hindi", "Maori", 'Nepali'], horizontal=True, index=2)
cont1 = c1.form('form', border=True)
cont2 = c2.container(border=True, height=240)
cont2.write(':blue[**Translated Text:**]')
text = cont1.text_area("Enter Text", placeholder="Type Here", label_visibility="collapsed", height=150, key='text')
cont = st.container(border=True, height=240)
...
# cont2.text_area("Translated Text", value=resp, placeholder="Translated Text", label_visibility="collapsed", height=150, disabled=True)
